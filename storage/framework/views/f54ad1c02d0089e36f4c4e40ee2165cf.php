...
<?php $component->withAttributes([]); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <p class="font-semibold"><?php echo e($config->user->name); ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Période</p>
                    <p class="font-semibold"><?php echo e(ucfirst($config->period_type)); ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Taux de Gain</p>
                    <p class="font-semibold"><?php echo e($config->win_rate); ?>%</p>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Paris par Jour</p>
                    <p class="font-semibold"><?php echo e($config->daily_bet_count); ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Plage de Mise</p>
                    <p class="font-semibold"><?php echo e(number_format($config->min_bet)); ?> - <?php echo e(number_format($config->max_bet)); ?> FCFA</p>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Statut</p>
                    <p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($config->is_active): ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'success']); ?>Actif <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'danger']); ?>Inactif <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal986dce9114ddce94a270ab00ce6c273d)): ?>
<?php $attributes = $__attributesOriginal986dce9114ddce94a270ab00ce6c273d; ?>
<?php unset($__attributesOriginal986dce9114ddce94a270ab00ce6c273d); ?>
...
<?php $component->withAttributes(['class' => 'h-full']); ?>
                <div class="text-center">
                    ...
                    <p class="text-3xl font-bold text-primary-600"><?php echo e(number_format($stats['total_bets'])); ?></p>
                    <p class="text-xs text-gray-400 mt-2">
                        <span class="text-green-600"><?php echo e(number_format($stats['total_wins'])); ?></span> gains /
                        <span class="text-red-600"><?php echo e(number_format($stats['total_losses'])); ?></span> pertes
                    </p>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['class' => 'h-full']); ?>
                <div class="text-center">
                    ...
                    <p class="text-3xl font-bold text-purple-600"><?php echo e(number_format($stats['avg_win_rate'], 1)); ?>%</p>
...
<?php $component->withAttributes(['class' => 'h-full']); ?>
                <div class="text-center">
                    ...
                    <p class="text-3xl font-bold text-blue-600"><?php echo e(number_format($stats['total_bet_amount'], 0)); ?></p>
...
<?php $component->withAttributes(['class' => 'h-full']); ?>
                <div class="text-center">
                    ...
                    <p class="text-3xl font-bold <?php echo e($stats['net_amount'] >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                        <?php echo e(number_format($stats['net_amount'], 0)); ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <p class="text-2xl font-bold text-green-600 mb-4"><?php echo e(number_format($stats['total_win_amount'], 0)); ?> FCFA</p>
                <div class="w-full bg-gray-200 rounded-full h-3">
                    <?php
                        $total = $stats['total_win_amount'] + $stats['total_loss_amount'];
                        $winPercent = $total > 0 ? ($stats['total_win_amount'] / $total) * 100 : 0;
                    ?>
                    <div class="bg-green-600 h-3 rounded-full transition-all duration-500" style="width: <?php echo e($winPercent); ?>%"></div>
                </div>
                <p class="text-xs text-gray-500 mt-2"><?php echo e(number_format($winPercent, 1)); ?>% du total</p>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalee08b1367eba38734199cf7829b1d1e9)): ?>
<?php $attributes = $__attributesOriginalee08b1367eba38734199cf7829b1d1e9; ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <p class="text-2xl font-bold text-red-600 mb-4"><?php echo e(number_format($stats['total_loss_amount'], 0)); ?> FCFA</p>
                <div class="w-full bg-gray-200 rounded-full h-3">
                    <?php
                        $lossPercent = $total > 0 ? ($stats['total_loss_amount'] / $total) * 100 : 0;
                    ?>
                    <div class="bg-red-600 h-3 rounded-full transition-all duration-500" style="width: <?php echo e($lossPercent); ?>%"></div>
                </div>
                <p class="text-xs text-gray-500 mt-2"><?php echo e(number_format($lossPercent, 1)); ?>% du total</p>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalee08b1367eba38734199cf7829b1d1e9)): ?>
<?php $attributes = $__attributesOriginalee08b1367eba38734199cf7829b1d1e9; ?>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('chartComponent', () => ({
                chart: null,
                chartData: <?php echo json_encode($this->getChartData(), 15, 512) ?>,
...
<?php endif; ?>
<?php /**PATH /Users/macbookpro/Desktop/Developments/Personnals/winpawa/winpawa_backend/resources/views/filament/resources/demo-configuration-resource/pages/view-demo-configuration.blade.php ENDPATH**/ ?>